...
export interface Conditions {
	...
	"_vertical": string
	/** `@media screen and (min-width: 24.875em)` */
	"sm": string
	/** `@media screen and (min-width: 24.875em) and (max-width: 47.9975em)` */
	"smOnly": string
	/** `@media screen and (max-width: 24.8725em)` */
	"smDown": string
	...
	/** `@media screen and (min-width: 24.875em) and (max-width: 47.9975em)` */
	"smToMd": string
	/** `@media screen and (min-width: 24.875em) and (max-width: 63.9975em)` */
	"smToLg": string
	/** `@media screen and (min-width: 24.875em) and (max-width: 79.9975em)` */
	"smToXl": string
	/** `@media screen and (min-width: 24.875em) and (max-width: 95.9975em)` */
	"smTo2xl": string
	/** `@media screen and (min-width: 48em) and (max-width: 63.9975em)` */
	"mdToLg": string
